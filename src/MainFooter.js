                    ...
                    <div className="row row-cols-1 row-cols-lg-3">
                        <div className="col">
                            <ul className="list-inline my-2">
                                ...
                                <li className="list-inline-item"><a href="mailto:<lemaca.alpaca@gmail.com>">lemaca.alpaca@gmail.com</a></li>
                            </ul>
                        </div>
                        <div className="col">
                            <ul className="list-inline my-2" styles="display: block;">
                                <li className="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-facebook">
                                    ...
                                    <li className="list-inline-item"><a href="https://www.facebook.com/profile.php?id=100094082500957">Facebook</a></li>
                            </ul>
                        </div>
                        <div className="col">
                            <ul className="list-inline my-2">
